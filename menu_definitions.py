...
add_menu = Menu(
    "add",
    "Please indicate what you want to add:",
    [
        ...
        Option("Student to PassFail", "add_pass_fail(db)"),
        Option("Student to LetterGrade", "add_letter_grade(db)"),
        Option("Exit", "pass"),
    ],
)
...
delete_menu = Menu(
    "delete",
    "Please indicate what you want to delete from:",
    [
        ...
        Option("Student from Major", "delete_student_major(db)"),
        Option("Student from Section", "delete_enrollment(db)"),
        Option("Exit", "pass"),
    ],
)
...
list_menu = Menu(
    "list",
    "Please indicate what you want to list:",
    [
        ...
        Option("Students in a Major", "list_students_in_major(db)"),
        Option("Students in a Section", "list_students_in_section(db)"),
        Option("Exit", "pass"),
    ],
)
